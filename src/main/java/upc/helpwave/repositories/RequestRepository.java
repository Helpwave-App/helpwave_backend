...
public interface RequestRepository extends JpaRepository<Request, Integer> {
    ...
    @Query("SELECT r FROM Request r WHERE r.stateRequest = true AND r.dateRequest < :threshold AND NOT EXISTS " +
            "(SELECT e FROM Empairing e WHERE e.request = r AND e.stateEmpairing = true)")
